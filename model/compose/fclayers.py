...
class FCLayers(nn.Module):
    """
        A class to build fully-connected layers for a neural network.
    ...
    def __init__(
        ...
        super().__init__()
        self.inject_convariates = inject_covariates
            ...
            collections.OrderedDict(
                [
                    (
                        "Layer {}".format(i),
                        nn.Sequential(
                            nn.Linear(n_in + cat_dim * self.inject_into_layer(i), n_out, bias),
